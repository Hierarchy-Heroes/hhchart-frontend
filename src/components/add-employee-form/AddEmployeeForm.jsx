...
const AddEmployeeForm = ({ visible, onClickClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const body = {
      ...
      'companyId': companyId, //OPTIONAL: get from context like companyName
      'password': 'password', //generated by backend?
      'positionTitle': form.positionTitle.value, //OPTIONAL
      'companyName': companyName,
      'isManager': isManager,
      'employeeId': 99999, //generated by backend?
      'managerId': 2, //generated by backend?
      'email': form.email.value,
      //'startDate': '10/20/2020' //OPTIONAL: generated by backend?
    }
    try {
